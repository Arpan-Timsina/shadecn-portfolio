...
import ContactPage from './page'; // Renamed
...
// Mock SendEmail server action for ContactForm
jest.mock('@/components/SendEmail', () => ({
  SendEmail: jest.fn().mockResolvedValue({}), // Mock it as an async function
}));
